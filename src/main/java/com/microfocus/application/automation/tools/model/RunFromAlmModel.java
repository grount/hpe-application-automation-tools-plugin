...
public class RunFromAlmModel {
    ...
    public static final EnumDescription runModeLocal = new EnumDescription(
            "RUN_LOCAL", "Run locally");
    public static final EnumDescription runModePlannedHost = new EnumDescription(
            "RUN_PLANNED_HOST", "Run on planned host");
    public static final EnumDescription runModeRemote = new EnumDescription(
            "RUN_REMOTE", "Run remotely");
    public static final List<EnumDescription> runModes = Arrays.asList(
            runModeLocal, runModePlannedHost, runModeRemote);
    public static final int DEFAULT_TIMEOUT = 36000; // 10 hrs
